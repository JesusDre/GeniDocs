...
@Entity
@Table(name = "requerimientos_no_funcionales")
public class RequerimientoNoFuncional {
    ...
    private List<VersionRequerimientoNoFuncional> versiones;
    ...
    public List<VersionRequerimientoNoFuncional> getVersiones() {
        return versiones;
    }

    public void setVersiones(List<VersionRequerimientoNoFuncional> versiones) {
